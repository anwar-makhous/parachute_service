...
class PlaceLocation extends StatefulWidget {
  static LatLng initialPosition = const LatLng(35.6130, 36.0023);
...
class _PlaceLocationState extends State<PlaceLocation> {
  ...
  Widget build(BuildContext context) {
    List<Component> _countries = [Component(Component.country, 'sy')];
    return SafeArea(
      top: true,
      child: Stack(
        children: [
          Scaffold(
            ...
            selectedPlaceWidgetBuilder:
              ...
              if (selectedPlace != null) {
                if (selectedPlace.formattedAddress!.contains('Syria')) {
